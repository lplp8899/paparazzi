...
//#include <stdlib.h>
//#include <stdio.h>
//#include <inttypes.h> // for print uint_8
//#include "modules/computer_vision_Lu/lib/v4l/v4l2.h"
//#include "modules/computer_vision_Lu/cv/image.h"
//#include "modules/computer_vision_Lu/viewvideo.h"
...
{
  // V5.4 (Release)
  //waypoints[WP_STDBY].x = meters * 256; // (1<<POS_FRAC)
  ...
  n.y = 20.0;
  n.z = -2;
  nav_set_waypoint_enu_f(WP_STDBY, &n);
}
//------------------ changed by Peng --------------------
*/
...
void run_hover_stabilization_onvision(struct CVresults* vision )
{
  ...
  DOWNLINK_SEND_OF_HOVER(DefaultChannel, DefaultDevice,
                         ...
                         &V_body.x, &V_body.y,
                         &vision->cam_h, &vision->count,&vision->yaw_ref);
...
cmd_euler.psi = vision->yaw_ref;
//float cmd_euler_psi = cmd_euler.psi ;
